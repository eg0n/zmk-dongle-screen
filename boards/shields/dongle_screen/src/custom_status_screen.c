...
lv_obj_t *zmk_display_status_screen() {
    ...
    lv_obj_align(zmk_widget_animation_obj(&animation_widget),
                 LV_ALIGN_RIGHT_MID, -35, 0);
#endif
